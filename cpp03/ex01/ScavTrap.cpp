...
/*   Updated: 2024/12/05 23:02:36 by tchartie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ScavTrap::guardGate() {
	if (this->_isGuard == false) {
		this->_isGuard = true;
		std::cout << MAGENTA << this->_name << CYAN " is now in Gate keeper mode" BASE_COLOR << std::endl << std::endl;
	}
	else {
		this->_isGuard = false;
		std::cout << MAGENTA << this->_name << CYAN " is no longer in Gate keeper mode" BASE_COLOR << std::endl << std::endl;
	}
}
